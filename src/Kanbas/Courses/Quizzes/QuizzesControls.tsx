    ...
    <div id="wd-quizzes-controls" className="text-nowrap mt-3">
      <div className="row align-items-center w-100">
        ...
        <div className="col-md-4 text-end d-flex justify-content-end align-items-center">
          <Link to="new" id="wd-add-quizzes-btn" className="btn btn-lg btn-danger me-2 d-flex align-items-center" style={{ height: '40px' }}>
            <FaPlus className="me-2" style={{ bottom: "1px" }} />
            Quiz
          </Link>
          <button className="btn btn-light border d-flex align-items-center" style={{ height: '40px', padding: '0 10px' }}>
